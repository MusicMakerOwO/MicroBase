...
function parse(message) {
	...
	const properties = _nodeutil.inspect.call(void 0, message, { depth: 3 });
...
function custom(message, hexColor = 0x000000) {
...
exports. default = { getTimestamp, info, warn, error, success, debug, deleted, updated, created, custom };
