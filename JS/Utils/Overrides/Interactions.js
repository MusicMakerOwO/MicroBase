...
"use strict"; function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }// @ts-nocheck
// This is all correct and really doesn't add any typings, TS gets that from the typings.de.ts file instead
// I will just have to be super careful to test everything here
...
class InteractionOverrides {
	...
	async deferUpdate(options = {}) {
		...
		return options.fetchReply ? this.fetchReply() : new InteractionResponse(this, _optionalChain([this, 'access', _ => _.message, 'optionalAccess', _2 => _2.interaction, 'optionalAccess', _3 => _3.id]));
	}
	...
	async update(options) {
		...
		return options.fetchReply ? this.fetchReply() : new InteractionResponse(this, _optionalChain([this, 'access', _4 => _4.message, 'access', _5 => _5.interaction, 'optionalAccess', _6 => _6.id]));
	}
...
InteractionOverrides.overrideInteractionResponses();